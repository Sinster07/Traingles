...
function calculateArea(e) {
  ...
  if(firstSideValue<=0 || secondSideValue<=0 || secondSideValue<=0){
    output.innerText = "Enter valid side lengths of traingle!!";
  }
  else if (
   ...
   {
    output.innerText = "Enter valid side lengths of the traingle!!";
  }
